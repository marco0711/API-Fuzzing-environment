...
** Create Forks
You need to create forks of the [targets][https://github.com/marco0711/API-Fuzzing-environment/blob/master/README.org#targets] and [schemas][https://github.com/marco0711/API-Fuzzing-environment/blob/master/README.org#schemas]. This is to support mutation testing. Despite whether you use mutation testing or not, this is mandatory.
