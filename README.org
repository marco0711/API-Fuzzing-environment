...
** Create Forks
You need to create forks of the [[targets]] and [[https://github.com/marco0711/API-schemas][schemas]]. This is to support mutation testing. Despite whether you use mutation testing or not, this is mandatory.
