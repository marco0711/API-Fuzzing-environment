...
** Create Forks
You need to create forks of the [[https://github.com/marco0711/API-Fuzzing-environment/blob/master/README.org#targets][targets]] and [[https://github.com/marco0711/API-Fuzzing-environment/blob/master/README.org#schemas][schemas]]. This is to support mutation testing. Despite whether you use mutation testing or not, this is mandatory.
